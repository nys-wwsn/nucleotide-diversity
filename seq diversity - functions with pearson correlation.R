...
cor_ci_function <- function(dataframe,
  ...
  # docstring information
  #' Output a Pearson correlation with 95% CI
  #' 
  #' @description This function outputs Pearson correlation values for each
  ...
  pearson_statistic <- case_cor$estimate
  ...
  pearson_statistic_h <- hosp_cor$estimate
  ...
  row_df <- as.data.frame(cbind(predictor_group,
                                Region, 
                                paste(
                                  signif(pearson_statistic, 3), 
                                  paste("[", signif(ll, 3), ", ", 
                                        signif(ul, 3), "]", sep = ""),
                                  sep = " "), 
                                paste(
                                  signif(pearson_statistic_h, 3), 
                                  paste("[", signif(ll_h, 3), ", ", 
                                        signif(ul_h, 3), "]", sep = ""),
                                  sep = " "),
                                observations
...
# function for comparing the Pearson correlation coefficients across spatial
# scales
